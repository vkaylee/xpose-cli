# --- Stage 1: Planner ---
FROM lukemathwalker/cargo-chef:latest-rust-1.85.0-slim-bookworm AS planner
WORKDIR /workspace
COPY . .
RUN cargo chef prepare --recipe-path recipe.json

# --- Stage 2: Cacher ---
FROM lukemathwalker/cargo-chef:latest-rust-1.85.0-slim-bookworm AS cacher
WORKDIR /workspace
...
FROM rust:1.85.0-slim-bookworm AS dev
WORKDIR /workspace
